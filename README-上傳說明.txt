...
3. 更新 GitHub Pages 的版本號、Service Worker 快取版本與載入查詢參數。
4. 上線前必須在 Supabase SQL Editor 執行 `supabase/license-recovery.sql`。
...
6. 等 GitHub Pages 部署完成後，用一般 Safari 開啟：
   https://hsujeff802-web.github.io/shuangfa-payment/?v=83421
